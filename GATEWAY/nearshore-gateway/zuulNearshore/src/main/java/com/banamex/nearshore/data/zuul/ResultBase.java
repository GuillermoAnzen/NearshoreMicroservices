package com.banamex.nearshore.data.zuul;
...
public class ResultBase {
	...
	public ResultBase(boolean success, int codigo,  String mensaje) {
		super();
	...
	public ResultBase(boolean success, String mensaje, Object data, int codigo, String exception) {
		super();
		this.success = success;
		this.mensaje = mensaje;
		this.data = data;
